...
== Demo Actions
* Go to localhost:3000 and click sign up to create a new user
...
* Click on one of the results and then click on 'Search' to see the results

== Unit Testing
* run 'rake test' to see testing results
